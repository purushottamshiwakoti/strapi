"use strict";(self.webpackChunkstrapi_project=self.webpackChunkstrapi_project||[]).push([[3358],{67479:(rt,U,s)=>{s.d(U,{S:()=>$});var t=s(92132),_=s(63891),p=s(44370),G=s(24122),m=s(43242),S=s(57842);const F=(0,_.default)(p.a)`
  height: ${24/16}rem;
  width: ${24/16}rem;
  border-radius: 50%;
  display: flex;
...
`,N=(0,_.default)(p.a)`
  ...
  width: 100%;
  border: none;
`,$=({children:x,icon:X,...z})=>(0,t.jsxs)("div",{children:[(0,t.jsx)(G.c,{}),(0,t.jsx)(N,{as:"button",background:"primary100",padding:5,...z,children:(0,t.jsxs)(m.s,{children:[(0,t.jsx)(F,{"aria-hidden":!0,background:"primary200",children:X}),(0,t.jsx)(p.a,{paddingLeft:3,children:(0,t.jsx)(S.o,{variant:"pi",fontWeight:"bold",textColor:"primary600",children:x})})]})})]})},30977:(rt,U,s)=>{s.r(U),s.d(U,{default:()=>Nt});var t=s(92132),_=s(44370),p=s(43242),G=s(27026),m=s(57842),S=s(79318),F=s(70768),N=s(34508),$=s(21270),x=s(69564),X=s(67479),z=s(19106),dt=s(43121),ct=s(32559),d=s(8769),ht=s(98889),R=s(31127),H=s(31708),_t=s(39423),pt=s(95350),gt=s(50350),ut=s(13333),ft=s(95065),D=s(2600),mt=s(412),Y=s(56336),J=s(39404),I=s(54894),Q=s(17703),W=s(21272),r=s(49946),E=s(63891),kt=s(14718),Zt=s(51156),Vt=s(48940),Gt=s(77160),Xt=s(21835),Qt=s(17024),wt=s(51187),Ht=s(12083),Yt=s(94710),Jt=s(14311),qt=s(82437),te=s(89102),ee=s(5409),se=s(35336),ne=s(71547),oe=s(58692),ae=s(71210),ie=s(5790),le=s(35223),re=s(45635);const Et=(0,E.default)(_.a)`
  table {
    width: 100%;
    white-space: nowrap;
  }
...
`,tt=({customRowComponent:e,component:n,isFromDynamicZone:o=!1,isNestedInDZComponent:a=!1,firstLoopComponentUid:c})=>{const{modifiedData:l}=(0,r.u)(),{schema:{attributes:g}}=D(l,["components",n],{schema:{attributes:[]}});return(0,t.jsx)(q,{isChildOfDynamicZone:o,className:"component-row",children:(0,t.jsx)("td",{colSpan:12,children:(0,t.jsx)(st,{customRowComponent:e,items:g,targetUid:n,firstLoopComponentUid:c||n,editTarget:"components",isFromDynamicZone:o,isNestedInDZComponent:a,isSub:!0,secondLoopComponentUid:c?n:null})})})},xt=({isActive:e=!1,icon:n="cube"})=>(0,t.jsx)(p.s,{alignItems:"center",background:e?"primary200":"neutral200",justifyContent:"center",height:8,width:8,borderRadius:"50%",children:(0,t.jsx)(G.I,{as:r.C[n]||r.C.cube,height:5,width:5})}),et=(0,E.default)(_.a)`
  position: absolute;
  display: none;
  top: 5px;
  right: ${(0,d.a8)(8)};
