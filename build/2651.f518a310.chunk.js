"use strict";(self.webpackChunkstrapi_project=self.webpackChunkstrapi_project||[]).push([[2651],{94061:(j,m,t)=>{t.d(m,{a:()=>p});var i=t(63891),d=t(28672),a=t(5146);const o={color:!0,cursor:!0,height:!0,width:!0},p=i.default.div.withConfig({shouldForwardProp:(e,s)=>!o[e]&&s(e)})`
  // Font
  ...
  // Cursor
  cursor: ${({cursor:e})=>e};
`},83997:(j,m,t)=>{t.d(m,{s:()=>p});var i=t(63891),d=t(28672),a=t(94061);const o={direction:!0},p=(0,i.default)(a.a).withConfig({shouldForwardProp:(e,s)=>!o[e]&&s(e)})`
...
`},30893:(j,m,t)=>{t.d(m,{o:()=>I});var i=t(63891);const d="alpha",a="beta",o="delta",p="epsilon",e="omega",s="pi",f="sigma",P=[d,a,o,p,e,s,f],y=({ellipsis:u=!1})=>u&&`
    display: block;
    white-space: nowrap;
    overflow: hidden;
  ...
  `,W=({variant:u=e,theme:n})=>{switch(u){case d:return`
      ...
      `;default:return`
        font-size: ${n.fontSizes[2]};
      `}};var D=t(5146);const A={fontSize:!0,fontWeight:!0},I=i.default.span.withConfig({shouldForwardProp:(u,n)=>!A[u]&&n(u)})`
  ${W}
  ${y}
...
`},28672:(j,m,t)=>{t.d(m,{A:()=>i});const i=(d,a,o)=>{if(!a)return;if(typeof a=="object")return(Array.isArray(a)?a:[a?.desktop,a?.tablet,a?.mobile]).reduce((f,P,y)=>{if(P)switch(y){case 0:return`${f}${d}: ${o.spaces[P]};`;case 1:return`${f}${o.mediaQueries.tablet}{${d}: ${o.spaces[P]};}`;case 2:return`${f}${o.mediaQueries.mobile}{${d}: ${o.spaces[P]};}`;default:return f}return f},"");const p=o.spaces[a]??a;return`${d}: ${p};`}},5146:(j,m,t)=>{t.d(m,{K:()=>a});function i(o,p){return typeof o=="string"?!1:p in o}function d(o){return o&&typeof o=="object"&&!Array.isArray(o)}function a(o,p,e){return p&&i(o,p)?o[p]:e}},37679:(j,m,t)=>{t.d(m,{B:()=>P});var i=t(92132),d=t(21272),a=t(63891),o=t(94061),p=t(30893);const e=()=>(0,i.jsx)(o.a,{"aria-hidden":!0,paddingLeft:1,paddingRight:1,children:(0,i.jsx)(p.o,{variant:"pi",textColor:"neutral500",children:"/"})});e.displayName="Divider";var s=t(83997);const f=(0,a.default)(s.s)`
